...
def interactive_loop(chain, vector_rag: VectorRAG, save_html: Optional[str] = None, *, simple: bool = False):
...
def main(argv: List[str] | None = None):
    ...
    if args.threat:
        ...
        interactive_loop(chain, vector_rag, save_html=(args.save_html or None), simple=args.simple)
